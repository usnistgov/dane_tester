...
In addition to storing trust information for SSL servers, there are
...
(associated with both the mail server's domain name and the domain name of the MX
server) against one or more DANE TLSA RRs.
