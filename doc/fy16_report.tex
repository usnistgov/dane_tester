...
\texttt{dane_checker.py} script or from a web browser by placing the
\texttt{dane_check.cgi} script and the associated files in a
...
\item Run \texttt{python2.7 test_dane.py --test} to test all of the
  test vectors.
\item Run \texttt{python2.7 test_dane.py
  https://good.dane.verisignlabs.com} to test Verisign's known-good
  DANE https server.
\item Run \texttt{python2.7 test_dane.py
  https://bad-sig.dane.verisignlabs.com} to test one of Verisign's
