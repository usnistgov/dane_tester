...
\end{tabularx}
\caption{Slots in the DaneTest object}\ref{slots}\\
\end{table}
...
\end{tabular}
\caption{Test numbers for DANE tests}\ref{ranges}
\end{table}
...
web page \url{http://dane-test.had.dnsops.gov} is installed in the
